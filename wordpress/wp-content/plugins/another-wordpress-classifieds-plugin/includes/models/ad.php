...
class AWPCP_Ad {
	...
	public static function  find_by_county_id($id) {
		return self::find(sprrintf('county_id = %d', (int) $id));	
	}
	...
	public function save() {
		...
		$data = array(
			...
			'county_id' => awpcp_get_property($this, 'county_id'), // Custom
